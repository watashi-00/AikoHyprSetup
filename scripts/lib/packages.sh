    ...
    case "$1" in
        pacman)
            printf '%s\n' \
                ...
                python-gobject python-psutil python-cairo socat fastfetch wf-recorder mpv mpvpaper
            ;;
        apt)
            printf '%s\n' \
                ...
                python3-gi python3-psutil python3-cairo socat fastfetch wf-recorder mpv mpvpaper
            ;;
        dnf)
            printf '%s\n' \
                hyprland waybar wofi mako hyprpaper kitty jq playerctl cava \
                ...
                python3-gobject python3-psutil python3-cairo socat fastfetch wf-recorder mpv mpvpaper
            ;;
        zypper)
            printf '%s\n' \
                hyprland waybar wofi mako hyprpaper kitty jq playerctl cava \
        ...
        apk)
            printf '%s\n' \
                ...
                py3-gobject3 py3-psutil py3-cairo socat fastfetch wf-recorder mpv mpvpaper
            ;;
    esac
}
...
install_one_package() {
    ...
    if [ "$pm" = "pacman" ] && [ "$pkg" = "waybar" ]; then
        ...
        if sudo_cmd pacman -S --noconfirm waybar; then
            return 0
        else
